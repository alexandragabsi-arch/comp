...
PROCÈS-VERBAL [D'ASSEMBLÉE GÉNÉRALE EXTRAORDINAIRE / DE L'ASSOCIÉ UNIQUE / DÉCISIONS UNANIMES DES ASSOCIÉS]
Fait à [VILLE], le [DATE]

OUVERTURE DE LA SÉANCE
[AGE] : Le [date] à [heure], les associés se sont réunis en AGE, convoqués par [mode] le [date]. Totalisent [XXX] parts sur [XXX]. Présidée par [civilité] [nom], qualité [gérant/président]. Assemblée régulièrement constituée. Aucune question écrite / Questions écrites prises en compte.
[Associé unique / Unanime] : Le [date], l'associé unique / la totalité des associés, représentant l'intégralité du capital, ont pris unanimement les décisions suivantes.

Ordre du jour :
[Si changement de dirigeant] : • Fin des fonctions de dirigeant de [nom] ;
[Si changement de dirigeant] : • Nomination en tant que [fonction] de [nom] ;
• Approbation de la qualité de nouvel associé à [cessionnaire] ;
• Agrément à la cession des parts/actions ;
• Constatation de la cession ;
• Délégation des pouvoirs en vue des formalités.

RÉSOLUTION 1 — DÉMISSION DU DIRIGEANT [si applicable]
Prise d'acte de la démission de [civilité] [nom], né(e) le [date], de ses fonctions de [gérant/président], à compter du jour de la cession.
Quitus entier et définitif de sa gestion.
Résolution adoptée à l'unanimité.

RÉSOLUTION 2 — NOMINATION DU NOUVEAU DIRIGEANT [si applicable]
Nomination de [cessionnaire — infos complètes] en qualité de [fonction], à compter du jour de la cession, pour une durée [illimitée / de X années].
Résolution adoptée à l'unanimité.

RÉSOLUTION [N] — APPROBATION DE LA QUALITÉ DE NOUVEL ASSOCIÉ
Décision de donner la qualité d'associé à [cessionnaire — infos complètes], à compter du jour de la cession.
Résolution adoptée à l'unanimité.

RÉSOLUTION [N+1] — AGRÉMENT DE LA CESSION
Après prise de connaissance du projet de cession entre :
• Le Cédant : [nom cédant]
• Le Cessionnaire : [nom cessionnaire]
Portant sur [XXX] parts/actions, représentant [XX%] du capital. Autorisation expresse dans les conditions prévues aux statuts et à l'acte de cession signé ce jour.
Résolution adoptée à l'unanimité.

RÉSOLUTION [N+2] — CONSTATATION DE LA CESSION
Approbation et constatation de la cession de [XXX] parts/actions intervenue ce jour.
Répartition du capital après cession :
| Associé | Nb titres | % capital |
|---------|-----------|-----------|
| [Cessionnaire] | [XXX] | [XX%] |
| TOTAL | [XXX] | 100% |
Résolution adoptée à l'unanimité.
...
[Associé unique / Président seul]
LE PRÉSIDENT / GÉRANT
[Nom, Prénom] — Date : _____ — Signature : _____

[AGE / Décision unanime]
